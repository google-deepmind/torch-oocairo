...
of a circle centered at point (I<cx>,E<nbsp>I<cy>) with a radius of I<radius>.
...
(I<x>,E<nbsp>I<y>), with the control points (I<c1x>,E<nbsp>I<c1y>) and
(I<c2x>,E<nbsp>I<c2y>).  All six arguments must be numbers.
...
L<lua-oocairo-pattern(3)> for methods available on pattern objects.
