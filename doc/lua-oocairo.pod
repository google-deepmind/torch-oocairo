...
=item context_create_for_gdk_window (window)

Return a new context object for drawing on the GdkWindow object I<window>,
which must be from the Lua-Gnome library.

Fails unless the C<gtk> module has been loaded and the C<gtk> module is
available as a global variable.

See example program I<gtk-image.lua> for an example of how to use this.
...
I<stride> value for the C<image_surface_create_for_data()> function
